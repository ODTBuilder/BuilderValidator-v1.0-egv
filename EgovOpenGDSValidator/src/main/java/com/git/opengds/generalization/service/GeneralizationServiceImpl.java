...
public class GeneralizationServiceImpl extends EgovAbstractServiceImpl implements GeneralizationService {

	@Resource(name="generalizationLayerService")
	GeneralizationLayerService generalizationLayerService;

	@Resource(name="generalizationProgressService")
	GeneralizationProgressService progressService;

	@Resource(name="generalizationReportService")
