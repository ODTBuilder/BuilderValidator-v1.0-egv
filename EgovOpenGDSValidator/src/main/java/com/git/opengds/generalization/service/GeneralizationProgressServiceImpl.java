...
@Service("generalizationProgressService")
public class GeneralizationProgressServiceImpl extends EgovAbstractServiceImpl implements GeneralizationProgressService {

	@Resource(name="shpLayerCollectionDAO")
	private SHPLayerCollectionDAO shpDAO;

	@Resource(name="generalizationProgressDAO")
