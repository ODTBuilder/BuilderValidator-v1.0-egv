...
public class GeoserverServiceImpl extends EgovAbstractServiceImpl implements GeoserverService {
	...
	public FileMeta dbLayerPublishGeoserver(final UserVO userVO, GeoLayerInfo layerInfo) {
		final String wsName = userVO.getId();
		final String dsName = userVO.getId();

		final String fileName = layerInfo.getFileName();
		final List<String> layerNameList = layerInfo.getLayerNames();
		final String originSrc = "EPSG:" + layerInfo.getOriginSrc();
		final List<String> successLayerList = new ArrayList<String>();
		final String fileType = layerInfo.getFileType();
		// boolean flag = false;

		// Collection<Geometry> geometryCollection = new ArrayList<Geometry>();
		final GeometryFactory geometryFactory = JTSFactoryFinder.getGeometryFactory();

		final GeoserverSldTextType sldType = new GeoserverSldTextType(); // Geoserver
		// TEXT 타입
