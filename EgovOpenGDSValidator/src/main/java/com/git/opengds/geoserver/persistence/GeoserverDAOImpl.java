...
/*	public GeoserverDAOImpl(UserVO user) {
	...
	private static final String namespace = "com.git.GeolayerMapper";
	...
	public boolean selectEditLayerDuplicateCheck(UserVO userVO, Map<String,Object> infoMap){
		...
		int duplicateNums = 0;
		try{
			duplicateNums = selectOne(namespace + ".selectEditLayerDuplicateCheck", infoMap);
		}
		catch (Exception e) {
			e.printStackTrace();
		}
