...
@Service("errorLayerService")
//@ContextConfiguration(locations = { "file:src/main/webapp/WEB-INF/spring/**/*.xml" })
public class ErrorLayerServiceImpl extends EgovAbstractServiceImpl implements ErrorLayerService {

	@Resource(name="errorLayerDAO")
	...
	@Resource(name="validateProgressDAO")
