...
public class ErrorReportController extends AbstractController {
	...
	@ResponseBody
	public String seletErrorLayer(HttpServletRequest request, @RequestBody JSONObject geo) throws Exception {
		...
		JSONObject json = errReportService.getDetailsReport(generalUser, (String) geo.get("errorLayer"));
		if (json != null) {
