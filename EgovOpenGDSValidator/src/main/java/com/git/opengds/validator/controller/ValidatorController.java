...
public class ValidatorController extends AbstractController {
	...
	@ResponseBody
	public void geoserverAddLoadAjax(HttpServletRequest request, @RequestBody JSONObject geo) throws Exception {

		UserVO generalUser = (UserVO) getSession(request, EnUserType.GENERAL.getTypeName());
		if (generalUser == null) {
			// return null;
		}
		validatorService.validate(generalUser, geo.toString());
		// return
	}
}
