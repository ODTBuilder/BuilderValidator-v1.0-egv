...
@Service("editDTFeatureService")
//@ContextConfiguration(locations = { "file:src/main/webapp/WEB-INF/spring/**/*.xml" })
public class EditDTFeatureServiceImpl extends EgovAbstractServiceImpl implements EditDTFeatureService {
	...
	@Resource(name="editDBManagerService")
