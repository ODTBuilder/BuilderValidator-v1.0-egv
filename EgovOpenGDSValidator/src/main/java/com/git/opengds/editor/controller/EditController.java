...
public class EditController extends AbstractController {
	...
	@ResponseBody
	public boolean editLayerCollection(HttpServletRequest request, @RequestBody JSONObject geo) throws Exception {
		UserVO generalUser = (UserVO) getSession(request, EnUserType.GENERAL.getTypeName());
		boolean isSuccessed =  editService.editLayerCollection(generalUser, geo.toString());
		return isSuccessed;
	}
}
