...
<html>
<head>
<jsp:include page="/WEB-INF/jsp/egovframework/example/common/common3.jsp" />
	...
	<nav id='footer' class="navbar navbar-default navbar-fixed-bottom">
		...
		<footer class="container-fluid text-center">
			<img class="img-rounded" src="${pageContext.request.contextPath}/resources/img/openlayers.png" height="40px"
				style="padding-left: 15px"> <img class="img-rounded"
				src="${pageContext.request.contextPath}/resources/img/geoserver.png" height="40px" style="padding-left: 15px">
			<img class="img-rounded" src="${pageContext.request.contextPath}/resources/img/geotools.png" height="40px"
				style="padding-left: 15px"> <img class="img-rounded"
				src="${pageContext.request.contextPath}/resources/img/postgresql.png" height="40px" style="padding-left: 15px">
		</footer>
	</nav>
